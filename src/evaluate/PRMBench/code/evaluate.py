import json
import argparse
from collate import load_dataset
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", type=str, default="prm_result.jsonl")
    args = parser.parse_args()
    
    result_path = "../data/prm_result.jsonl"
    meta_data_path = "../data/meta_data.jsonl"
    
    results = load_dataset(result_path)
    meta_data = load_dataset(meta_data_path)
    
    res_log = evaluate_function(results, meta_data)
    write_jsonl(res_log, f'../data/{args.model_name}.jsonl')